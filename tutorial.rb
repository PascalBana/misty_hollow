...
def tutorial_monologue
  weapon = "Glaive"
  puts "As you speed through the misty forrest on a horse driven carriage,"
  puts "your bag falls off the seat from the bumps on the road."
  puts "The carriage driver calls back in an old gruff voice \"We'll"
  puts "be there soon, gather your belongings I dont have time"
  puts "for a long stop\". You jump down to hastly pick up your #{weapon} and"
  puts "pack. As you settle back onto your seat, you remember that your employer"
  puts "said he got you a room in a tavern called the Misty Step."
  puts "The idea of having to hunt something down in town sounds pretty"
  puts "shit, but given the amount of money on the table it would be hard"
  puts "to say no."
  puts ""
  sleep(4)
  puts""
